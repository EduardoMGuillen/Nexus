      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative">
          ...
          >
            ...
            <p className="text-lg text-dark-300 max-w-3xl mx-auto mb-8">{c.subtitle}</p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <div className="px-6 py-4 rounded-2xl bg-dark-800/60 border border-dark-700 min-w-[140px]">
                <p className="text-3xl font-bold text-white">{CATEGORY_ORDER.length}</p>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                  activeCategory === filter.key
                    ...
                    : "bg-dark-800/60 text-dark-300 border border-dark-700 hover:border-primary-500/40 hover:text-white"
                }`}
              >
                {filter.label}
              </button>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="mt-16 text-center p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-primary-500/10 to-cyan-500/10 border border-primary-500/20"
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">{c.ctaTitle}</h2>
            <p className="text-dark-300 mb-8 max-w-2xl mx-auto">{c.ctaBody}</p>
            <Link
              href="/#contacto"
