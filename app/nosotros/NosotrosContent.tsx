      ...
      <article className="pt-28 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-5xl">
          ...
          >
            ...
            <p className="text-lg text-dark-300 max-w-3xl leading-relaxed">{t.lead}</p>
          </motion.header>

          <section className="grid sm:grid-cols-3 gap-4 mb-14">
            <div className="rounded-2xl border border-dark-600 bg-dark-800/50 p-5">
              <MapPin className="w-5 h-5 text-primary-400 mb-3" />
              <h2 className="text-white font-semibold mb-1">{t.whereTitle}</h2>
              <p className="text-sm text-dark-300">{t.whereBody}</p>
            </div>
            <div className="rounded-2xl border border-dark-600 bg-dark-800/50 p-5">
              <Mail className="w-5 h-5 text-primary-400 mb-3" />
              <h2 className="text-white font-semibold mb-1">{t.contactTitle}</h2>
            ...
            <div className="rounded-2xl border border-dark-600 bg-dark-800/50 p-5">
              ...
              <h2 className="text-white font-semibold mb-1">{t.httpsTitle}</h2>
              <p className="text-sm text-dark-300">{t.httpsBody}</p>
            </div>
          </section>

          <section className="mb-14">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">{t.storyTitle}</h2>
            {t.story.map((p) => (
              <p key={p.slice(0, 32)} className="text-dark-300 leading-relaxed mb-4">
                {p}
              </p>
            ))}
          </section>
          ...
          <section className="mb-14">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white">{t.casesTitle}</h2>
            </div>
            <p className="text-dark-300 mb-8 max-w-2xl">{t.casesLead}</p>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <h3 className="text-white font-bold">{copy.name}</h3>
                        <a
                          href={c.url}
                          target="_blank"
                    ...
                    <p className="text-sm text-dark-300 mb-4">{copy.before}</p>
                    <p className="text-xs uppercase tracking-wide text-primary-500 mb-1">{t.afterLabel}</p>
                    <p className="text-sm text-dark-200 mb-4">{copy.after}</p>
                    <a
                      href={c.url}
                      target="_blank"
                      rel="noopener noreferrer"
          ...
          <p className="text-center">
            ...
            <Link href="/privacidad" className="text-dark-400 hover:text-dark-200 text-sm">
              {t.privacyLink}
            </Link>
          </p>
        </div>
