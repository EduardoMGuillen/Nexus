      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold mb-4">
            <span className="text-slate-900 dark:text-white">{m.process.titleOur}</span>{" "}
            <span className="gradient-text">{m.process.titleHighlight}</span>
          </h2>
        ...
        <div className="relative">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {m.process.steps.map((step, index) => {
                ...
                >
                  <div className="relative h-full p-6 bg-slate-100 dark:bg-dark-800/50 backdrop-blur-sm rounded-xl border border-slate-200 dark:border-dark-700 hover:border-primary-500/50 transition-all duration-300 text-center">
                    <motion.div
                      ...
                      className={`inline-flex p-4 rounded-xl bg-gradient-to-br ${color} mb-4`}
                    >
                    ...
                    <p className="text-slate-600 dark:text-dark-300 text-sm">{step.description}</p>
                  </div>
                </motion.div>
              );
            })}
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl">
            {m.process.benefits.map((benefit, index) => (
              <motion.div
                key={benefit}
